...
function RecentIssueCard(props) {
  const {
    status,
    issueId,
    title,
  ...
  return (
    ...
    >
      ...
      {/* Main card content */}
      <div
        className={`${priorityColors[priority].bg} p-4 cursor-pointer`}
        onClick={toggleExpand}
      >
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-sm font-semibold text-gray-700 bg-white px-2 py-0.5 rounded-md">
                {issueId}
              </span>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2">
              <div
                className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${priorityColors[priority].text}`}
              >
              ...
              <div
                className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-green-400`}
              >
